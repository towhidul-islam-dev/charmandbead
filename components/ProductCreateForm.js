                  ...
                  <div className="mt-3 sm:mt-4 space-y-2">
                    {pricingTiers.map((tier, idx) => (
                      <div key={idx} className="flex items-center gap-2 group">
                        <input type="number" placeholder="Min Qty" value={tier.minQuantity} onChange={(e) => updateTier(idx, 'minQuantity', e.target.value)} className="w-1/2 p-2.5 sm:p-3 text-sm sm:text-[11px] font-bold border border-gray-200 rounded-xl bg-white shadow-sm text-[#3E442B] placeholder:text-gray-300 outline-none focus:ring-2 focus:ring-[#EA638C]/30 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                        <input type="number" placeholder="Unit Price" value={tier.unitPrice} onChange={(e) => updateTier(idx, 'unitPrice', e.target.value)} className="w-1/2 p-2.5 sm:p-3 text-xs sm:text-[11px] font-bold border-none rounded-xl bg-white shadow-sm text-[#EA638C] placeholder:text-gray-300 outline-none focus:ring-1 focus:ring-[#EA638C]/30 text-center" />
