  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="px-2 py-12 mx-auto sm:px-4 md:px-8 max-w-7xl">
        ...
        {/* --- OPTIMIZED: Instagram Section (Responsive & Shrunk) --- */}
        <div className="mt-16 max-w-4xl mx-auto relative overflow-hidden bg-white rounded-[2.5rem] md:rounded-[3rem] border border-gray-100 shadow-xl flex flex-col md:flex-row items-stretch min-h-0">
          <div className="z-10 flex-1 p-8 md:p-10 bg-gradient-to-br from-white to-pink-50/20">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-[#3E442B] uppercase italic tracking-tighter leading-[0.95] mb-4">
              Style On <br /> 
              <span className="text-[#EA638C]">Your Feed.</span>
            </h2>

            <p className="max-w-[280px] mb-6 text-[11px] font-medium leading-relaxed text-gray-500">
              Scan the code to follow us for exclusive drops and design inspiration.
            </p>

            <a 
              href={instagramUrl}
              target="_blank"
              className="group inline-flex items-center gap-2.5 bg-[#3E442B] text-white px-5 py-3 rounded-xl hover:bg-black transition-all duration-500 shadow-lg shadow-[#3E442B]/20"
            >
          ...
          {/* Right Side - Shrunk for Desktop, Full Width for Mobile */}
          <div className="w-full md:w-[280px] bg-[#3E442B] p-6 md:p-8 flex flex-col items-center justify-center relative min-h-[260px] md:min-h-0">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#EA638C] rounded-full blur-[80px] opacity-20 animate-pulse" />
            <div className="relative group">
              ...
              <div className="relative bg-white p-3 rounded-[1.5rem] shadow-2xl transition-transform duration-700 group-hover:scale-105">
                <div className="p-1 border border-gray-100 border-dashed rounded-lg">
                  <InstagramQR url={instagramUrl} size={110} /> 
                </div>
                <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#EA638C] text-white px-2.5 py-1 rounded-full text-[6px] font-black uppercase tracking-widest whitespace-nowrap shadow-lg">
                  Scan to Follow
                </div>
              </div>
            </div>
