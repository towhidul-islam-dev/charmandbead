  ...
  return (
    <div className="max-w-5xl min-h-screen p-6 mx-auto space-y-12 bg-white md:p-10">
      <header className="flex items-center justify-between pb-8 border-b border-gray-100">
        ...
        {status && (
          <div
            className={`flex items-center gap-2 px-6 py-3 rounded-full text-[11px] font-black uppercase tracking-widest animate-bounce ${
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
        ...
        <section className="lg:col-span-1">
          <form
            ...
            className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-xl shadow-gray-200/50 sticky top-10"
          >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <p className="text-[9px] font-black text-[#3E442B] uppercase ml-2">
                    Banner Heading
                  </p>
                  <input
                    type="text"
                    ...
                    className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 ring-[#FBB6E6] transition-all text-[11px] font-bold uppercase"
                    required
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-100 bg-gray-50 rounded-2xl">
                  ...
                  <input
                    ...
                    className="w-16 bg-transparent outline-none text-right font-black text-[#3E442B] text-lg"
                  />
                </div>
              </div>
        ...
        <section className="space-y-6 lg:col-span-2">
          <div className="flex items-center justify-between px-4">
            <h2 className="text-[13px] font-black text-[#3E442B] uppercase tracking-[0.25em]">
              Live Banners
            </h2>
            <div className="flex-1 h-px mx-6 bg-gray-100"></div>
            <span className="text-[10px] font-black text-[#EA638C] bg-[#EA638C]/5 px-3 py-1 rounded-full uppercase">
                ...
                >
                  <div className="flex items-center min-w-0 gap-6">
                    <div className="relative w-36 h-20 bg-gray-100 rounded-[24px] overflow-hidden shadow-inner flex-shrink-0 border border-gray-100">
                      {slide.format === "pdf" ? (
                        <div className="w-full h-full flex items-center justify-center bg-red-50 text-[#EA638C] text-[10px] font-black">
                          CATALOGUE
                        </div>
                      ) : (
                        <img
                          src={slide.image}
                          className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 ${!slide.isActive && "grayscale"}`}
                          alt=""
                        />
                      )}
                    </div>
                    <div className="truncate">
                      <p className="font-black text-[12px] text-[#3E442B] uppercase tracking-wider">
                        {slide.title}
                      </p>

                      <div className="flex flex-wrap items-center gap-2 mt-2">
                        {/* 🟢 NEW: CREATION DATE BADGE */}
