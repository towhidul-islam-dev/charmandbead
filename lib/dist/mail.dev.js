...
//       subject: subject,
//       html: `
//         <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 2px solid #FBB6E6; border-radius: 24px; overflow: hidden; background-color: #ffffff;">
//           <div style="background-color: #3E442B; padding: 30px; text-align: center;">
//             <h1 style="color: #EA638C; margin: 0; font-style: italic; text-transform: uppercase; letter-spacing: 2px;">New Inquiry</h1>
//           </div>
//           <div style="padding: 40px; color: #3E442B; line-height: 1.6;">
//             ${html}
//           </div>
//           <div style="background-color: #FBB6E6; padding: 15px; text-align: center; font-size: 10px; color: #3E442B; font-weight: bold; text-transform: uppercase; letter-spacing: 1px;">
//             © 2026 YOUR BRAND MATERIALS
//           </div>
//         </div>
//       `,
//     });
