...
export const getProductById = cache(async (id) => {
    try {
        ...
        const product = await Product.findById(id)
            ...
            .select('name description price stock category categoryName subCategory subCategoryName imageUrl gallery variants hasVariants isNewArrival minOrderQuantity createdAt') 
            .lean();
