...
export const CATEGORY_DNA = [
  // MAIN CATEGORIES
  RESIN_CHARMS, ACRYLIC_CHARMS, SILVER_CHARMS, FLOWER_CHARMS, PENDANT,
  RAW_MATERIALS, PLIER, KEY_RING, FRUIT_CHARM, FOOD_CHARMS, PEARL_CHARM,
  LEAF_CHARM, CERAMIC_CHARMS, BEADS, CORD_THREAD, STAINLESS_STEEL,
  CCB_BEADS, LETTER_BEADS, BOX, PACKAGING, CARTOON,
  ...
  build("Rainbow charms", 110, RESIN_CHARMS._id),
  ...
  build("Transportation", 502, PENDANT._id),
  build("Lodging", 503, PENDANT._id),
...
export const getSubCategories = (parentId) => CATEGORY_DNA.filter(c => c.parentId === parentId);