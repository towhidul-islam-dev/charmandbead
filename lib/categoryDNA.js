...
const BUTTONS = build("Buttons", 2400);
...
export const CATEGORY_DNA = [
  ...
  //Buttons Charms
  build("Heart button", 2401, BUTTONS._id),
  build("Round button", 2402, BUTTONS._id),
  build("Apple button", 2403, BUTTONS._id),
  build("Kitten button", 2404, BUTTONS._id),
  build("Flower button", 2405, BUTTONS._id),
  build("Star button", 2406, BUTTONS._id),
];
