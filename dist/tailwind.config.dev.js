...
var _default = {
  ...
  theme: {
    ...
    }, _defineProperty(_extend, "backgroundImage", {
      "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
      "gradient-conic": "conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))",
      "contact-image": "url('https://unsplash.it/1000/1000?image=789')"
    }), _defineProperty(_extend, "minHeight", {
      "custom-min-h": "500px",
      "custom-h-form": "600px"
    }), _defineProperty(_extend, "minWidth", {
      "custome-w": "400px"
    }), _defineProperty(_extend, "gridTemplateColumns", {
    ...
    }), _defineProperty(_extend, "fontSize", {
      extraSmall: "8px",
      small: "10px"
    }), _defineProperty(_extend, "animation", {
    ...
    }), _defineProperty(_extend, "keyframes", {
      bounce: {
        "0%": {
